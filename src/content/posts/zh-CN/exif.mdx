...
例如：[https://nest-js.oss-accelerate.aliyuncs.com/nestTest/1/1738636470704.JPG?x-oss-process=image/info](https://nest-js.oss-accelerate.aliyuncs.com/nestTest/1/1738636470704.JPG?x-oss-process=image/info)
